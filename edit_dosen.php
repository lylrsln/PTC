...
<div class="col">
    ...
    <input type="text" class="form-control" id="email" name="email" value="<?php echo $dosen['email']; ?>" required>
</div>

<div class="col">
    <label for="telp" class="form-label">Telp:</label>
    <input type="text" class="form-control" id="telp" name="telp" value="<?php echo $dosen['telp']; ?>">
</div>

<div class="col">
    <label for="alamat" class="form-label">Alamat:</label>
    <input type="text" class="form-control" id="alamat" name="alamat"  value="<?php echo $dosen['alamat']; ?>" required>
</div>
</div>
