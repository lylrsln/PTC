...
if (isset($_POST['edit'])) {
    ...
    if (isset($_POST['dosen_mk_id']) && !empty($_POST['dosen_mk_id'])) {
        ...
        if (isset($_POST['dosen_id']) && isset($_POST['matkul_id']) && isset($_POST['prodi_id']) && isset($_POST['jurusan']) && isset($_POST['tahun_akademik_id']) ) {
            ...
            $sql = "INSERT INTO dosen_mk (dosen_id, matkul_id, prodi_id, jurusan, tahun_akademik_id) VALUES (?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("iiisi", $dosen_id, $matkul_id, $prodi_id, $jurusan, $tahun_akademik_id);
...
<html lang="en">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form method="POST" action="">
                            <br><center><h2><?php echo $edit_data ? 'Edit Data Dosen-MK' : 'Tambah Data Dosen-MK'; ?></h2></center>
                            <br>
                            <div class="mb-3 row">
        <div class="col">
    ...
    <div class="card-body">
        <div class="text-end mb-3">
            <button type="submit" onclick="window.location.href='buat_jadwal.php'" class="btn btn-primary mt-3">Buat Jadwal</button>
        </div>
