            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <br><center><h1>Manajemen Data Dosen</h1></center><br>

                        <form method="POST">
                            <br><center><h2>Tambah/Edit Data Dosen</h2><br></center>
                ...
                <!-- Bagian Tombol di Sebelah Kanan -->
            <center><button type="submit" class="btn btn-primary mt-3">Tambah Dosen</button></center>
